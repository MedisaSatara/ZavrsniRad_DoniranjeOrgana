...
namespace DoniranjeOrgana.Services.Database
{
    public static class Data
    {
        ...
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            Services.Database.Korisnik korisnik = new Services.Database.Korisnik()
            {
                KorisnikId = 1001,
                Ime = "Arijana",
                Prezime = "Husic",
            ...
            Services.Database.Korisnik korisnik2 = new Services.Database.Korisnik()
            {
                KorisnikId = 1002,
                Ime = "Medisa",
                Prezime = "Satara",
            ...
            Services.Database.Korisnik korisnik3 = new Services.Database.Korisnik()
            {
                KorisnikId = 1170,
                Ime = "Adna",
                Prezime = "Obradovic",
            ...
            Services.Database.Korisnik korisnik4 = new Services.Database.Korisnik()
            {
                KorisnikId = 1178,
                Ime = "Amina",
                Prezime = "Gerin",
            ...
            Services.Database.Korisnik korisnik5 = new Services.Database.Korisnik()
            {
                KorisnikId = 1179,
                Ime = "Selma",
                Prezime = "Sejtanic",
            ...
            modelBuilder.Entity<Specijalizacija>().HasData(
                new Specijalizacija()
                {
                    SpecijalizacijaId = 2001,
            ...
            #region DodavanjeDonorskiFormular
            modelBuilder.Entity<DonorskiFormula>().HasData(
              /*  new DonorskiFormula()
                {
                    DonorskiFormularId=4995,
                    DonorId = 5501,
                    DatumAzuriranja=new DateTime(2024,05,07),
                    DatumPrijave=new DateTime(2024,05,07),
                    Saglasnost=1,
                    OrganiZaDonaciju = "bubreg",
                    Napomena = "",

                },*/
                 new DonorskiFormula()
                 {
                     DonorskiFormularId = 4996,
                     DonorId = 5513,
                     DatumAzuriranja = new DateTime(2024, 05, 07),
                     DatumPrijave = new DateTime(2024, 05, 07),
                     Saglasnost = 1,
            ...
            #endregion
            #region Dodavanje DonacijaOrgana
  /*          modelBuilder.Entity<DonacijaOrgana>().HasData(
                new DonacijaOrgana()
                {
                    DonacijaOrganaId = 6345,
                    DonoriId = 5001,
                    DonorskiFormularId = 4995,
                    DatumAktivacije =new DateTime (2025,01,01),
                    StatusDonora = "Živi",
